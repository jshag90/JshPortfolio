	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="./usercontent">BULLETIN BOARD</a></li>
						...
						<form action="./boardwritepro" method="post">
							...
							<table class="table table-hover">
								...
								<tr>
									...
									<td><input name="bUserName" id="bUserName" type="text"
										value="${user.userName}" /></td>

								</tr>
								<tr>
									<td colspan="2"><textarea name="bContent" id="bContent"
							...
							<p>
								<input type="button" value="목록"
									onclick="location.href='./usercontent' "> <input
