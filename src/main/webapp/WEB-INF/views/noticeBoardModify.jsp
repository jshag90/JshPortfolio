...
<body>
	<div id="pagebody">
		<center>
			...
			<form action="./noticeboardmodifyproc" method="post">
수정페이지
				<table class="table-style-two" border="1" summary="게시판 등록">
					...
					<tr>
						...
						<td><input name="noticeTitle" id="noticeTitle" type="text" size="70" value="${notice.noticeTitle }"/></td>
					</tr>
					<tr>
						<th align="center">내용</th>
						<td><textarea rows="20" cols="80" name="noticeContent" >${notice.noticeContent}</textarea></td>
					</tr>
