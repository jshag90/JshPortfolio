...
<body>
	<div id="pagebody">
		<center>
			...
			<form action="./qnaboardwriteproc" method="post">
				...
				<table class="table-style-two" border="1" summary="게시판 등록">
					...
					<tr>
						...
						<td><input readonly="readonly" name="qnaUserName" id="qnaUserName" type="text" value="${user.userName}"/></td>
						
					</tr>
					
					<tr>
						<th align="center">질문</th>
						<td><textarea rows="3" cols="80" name="qnaQuestion"></textarea></td>
					</tr>
